...
def test_blockchain_initialization():
    ...
    try:
        ...
        print(f"✅ Python blockchain: {status['python_blockchain']}")
        print(f"✅ Solidity blockchain: {status['solidity_blockchain']}")
        print(f"✅ Solidity connected: {status['solidity_connected']}")
...
if __name__ == "__main__":
    ...
    success &= test_blockchain_initialization()
    
    if success:
        print("\n🎉 All tests passed! Ready for transaction testing.")
    else:
